...
var file_message_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x32, 0xb0, 0x03, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x12, 0x36,
	...
	0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x11, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61,
	...
	0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x16, 0x2e, 0x6d, 0x65, 0x73,
...
var file_message_proto_depIdxs = []int32{
	...
	8,  // 23: message.Strike.Signup:output_type -> message.ServerResponse
	8,  // 24: message.Strike.ConfirmChat:output_type -> message.ServerResponse
	8,  // 25: message.Strike.Login:output_type -> message.ServerResponse
	2,  // 26: message.Strike.SaltMine:output_type -> message.Salt
	8,  // 27: message.Strike.SendPayload:output_type -> message.ServerResponse
	9,  // 28: message.Strike.UserStatus:output_type -> message.StatusUpdate
	10, // 29: message.Strike.PayloadStream:output_type -> message.StreamPayload
