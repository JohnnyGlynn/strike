...
var file_message_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0xbd, 0x02, 0x0a, 0x11, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x45,
...
var file_message_proto_depIdxs = []int32{
	...
	20, // 22: message.EncryptedEnvelope.sent_at:type_name -> google.protobuf.Timestamp
	7,  // 23: message.Strike.Signup:input_type -> message.InitUser
	10, // 24: message.Strike.Login:input_type -> message.LoginVerify
	...
	14, // 29: message.Strike.SendPayload:input_type -> message.StreamPayload
	1,  // 30: message.Strike.PayloadStream:input_type -> message.UserInfo
	1,  // 31: message.Strike.PollServer:input_type -> message.UserInfo
	12, // 32: message.Strike.Signup:output_type -> message.ServerResponse
	12, // 33: message.Strike.Login:output_type -> message.ServerResponse
	4,  // 34: message.Strike.SaltMine:output_type -> message.Salt
	1,  // 35: message.Strike.UserRequest:output_type -> message.UserInfo
	3,  // 36: message.Strike.OnlineUsers:output_type -> message.Users
	13, // 37: message.Strike.StatusStream:output_type -> message.StatusUpdate
	12, // 38: message.Strike.SendPayload:output_type -> message.ServerResponse
	14, // 39: message.Strike.PayloadStream:output_type -> message.StreamPayload
	2,  // 40: message.Strike.PollServer:output_type -> message.ServerInfo
