...
var file_federation_federation_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x12, 0x37, 0x0a, 0x05, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x12, 0x18, 0x2e, 0x66, 0x65,
...
var file_federation_federation_proto_depIdxs = []int32{
	...
	2, // 5: federation.Federation.Relat:input_type -> federation.RelayPayload
	1, // 6: federation.Federation.Handshake:output_type -> federation.HandshakeAck
	3, // 7: federation.Federation.Relat:output_type -> federation.RelayAck
